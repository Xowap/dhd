...
([`hardware/kicad/dhd.kicad_sch`](https://github.com/Xowap/dhd/blob/develop/hardware/kicad/dhd.kicad_sch)).
...
Confirmed in [`firmware/src/main.rs`](https://github.com/Xowap/dhd/blob/develop/firmware/src/main.rs):
