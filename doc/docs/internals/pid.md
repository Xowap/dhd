...
Implemented in [`common/src/pid/controller.rs`](https://github.com/Xowap/dhd/blob/develop/common/src/pid/controller.rs) as a modified PD+I loop.
...
Implemented in [`common/src/pid/calibration.rs`](https://github.com/Xowap/dhd/blob/develop/common/src/pid/calibration.rs). Fully hardware-agnostic.
